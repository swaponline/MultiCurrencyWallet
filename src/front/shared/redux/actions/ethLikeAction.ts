...
class EthLikeAction {
  ...
  checkSwapExists = async (params) => {
    ...
    const Web3 = this.getCurrentWeb3()
    const swapContract = new Web3.eth.Contract(nativeCurrencySwapContractAbi, externalConfig.swapContract[this.tickerKey])
