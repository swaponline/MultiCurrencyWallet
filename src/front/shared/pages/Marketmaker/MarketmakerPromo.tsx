    ...
    return (
      <div styleName="mm-promo-page">
        <section styleName="how-to-earn">
          ...
          <p>Помимо этого, среди всех маркетмейкеров распределяются SWAP токены, которые можно продать или использовать для фарминга еще большей награды farm.swaponline.io</p>
        </section>
