...
const UTXO_to_ERC20CNDL = (coinName) => {
  class _UTXO_to_ERC20CNDL extends UTXOToEthToken {
    constructor(props) {
      super({
        ...props,
        fields: {
          currencyName: coinName,
          ethLikeCoin: `CNDL`,
          etherscanLink: config.link.cndlscan,
          ...config.swapConfig[coinName],
        },
      })
    }
  }
  return _UTXO_to_ERC20CNDL
}
...
const ERC20CNDL_to_UTXO = (coinName) => {
  class _ERC20CNDL_to_UTXO extends EthTokenToUTXO {
    constructor(props) {
      super({
        ...props,
        fields: {
...
const UTXO_to_CNDL = (coinName) => {
  class _UTXO_to_CNDL extends UTXOToEthLike {
    constructor(props) {
      super({
        ...props,
        fields: {
...
const CNDL_to_UTXO = (coinName) => {
  class _CNDL_to_UTXO extends EthLikeToUTXO {
    constructor(props) {
      super({
        ...props,
        fields: {
