...
const Ethereum = ({ history }) => history !== undefined && history.map((item, index) => 
    <tr key={index}>
        <td>
            <div className="table__coin">
                <div className='table__coin-img table__coin-eth'></div>
                <div className="table__coin-abbr">ETH</div>
                <div className="table__coin-name">Ethereum</div>
            </div>
        </td>
