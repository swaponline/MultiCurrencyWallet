...
function isValidNumber() {
  ...
  return _validate["default"].apply(this, parameters);
}
...
describe('validate', function () {
  ...
  it('should refine phone number validation in case extended regular expressions are set for a country', function () {
    ...
    isValidNumber('961111111', 'UZ').should.equal(true); // Different regular expressions for precise national number validation.
  ...
  it('should work in edge cases', function () {
    ...
    var thrower = function thrower() {
      return (0, _validate["default"])('+78005553535');
    };
