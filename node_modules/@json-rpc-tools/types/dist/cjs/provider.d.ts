...
export declare abstract class IJsonRpcConnection extends IEvents {
    ...
    abstract send(payload: JsonRpcPayload): Promise<void>;
}
export declare abstract class IBaseJsonRpcProvider extends IEvents {
    constructor();
    abstract connect(params?: any): Promise<void>;
    abstract disconnect(): Promise<void>;
    abstract request<Result = any, Params = any>(request: RequestArguments<Params>): Promise<Result>;
    protected abstract requestStrict<Result = any, Params = any>(request: JsonRpcRequest<Params>): Promise<Result>;
}
