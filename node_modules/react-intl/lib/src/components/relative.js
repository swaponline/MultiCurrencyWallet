...
function scheduleNextUpdate(updateTimer, updateIntervalInSeconds, unit, currentValueInSeconds, setUpdateTimer, setCurrentValueInSeconds) {
    ...
    setUpdateTimer(setTimeout(function () { return setCurrentValueInSeconds(nextInterestingValueInSeconds); }, delayInSeconds * 1e3));
    return clearUpdateTimer;
}
var FormattedRelativeTime = function (_a) {
    ...
    var _e = React.useState(), updateTimer = _e[0], setUpdateTimer = _e[1];
    ...
    React.useEffect(function () {
        return scheduleNextUpdate(updateTimer, updateIntervalInSeconds, unit, currentValueInSeconds, setUpdateTimer, setCurrentValueInSeconds);
