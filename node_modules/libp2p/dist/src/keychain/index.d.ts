...
declare class Keychain {
     ...
     * @class
     */
    constructor(store: Datastore, options: object);
    store: import("interface-datastore/src/types").Datastore;
    opts: any;
    /**
     * Gets an object that can encrypt/decrypt protected data
...
declare namespace Keychain {
    export { PeerId, Datastore, KeyInfo };
}
/**
 * Information about a key.
 */
...
type Datastore = import("interface-datastore/src/types").Datastore;
