		...
		<div styleName="advantages__content">
			...
			<article styleName="advantage">
				...
				<div styleName="advantage__txt">
					<p>
						<FormattedMessage id="advantagesTxt1" defaultMessage={`The exchange is happening between you and other crypto holders (peer-2-peer).
						No percentage charged of the transaction.`} />
					</p>
				</div>
			</article>
			...
			<article styleName="advantage">
				...
				<div styleName="advantage__txt">
					<p>
						<FormattedMessage id="advantagesTxt2" defaultMessage={`We do not require any registration or personal authentication.
						(we don’t collect any data about the users)`} />
			...
			<article styleName="advantage">
				...
				<div styleName="advantage__txt">
					<p>
						<FormattedMessage id="advantagesTxt3" defaultMessage={`No-one can interfere with the exchange process.`} />
					</p>
				</div>
			</article>
			...
			<article styleName="advantage">
				...
				<div styleName="advantage__txt">
					<p>
						<FormattedMessage id="advantagesTxt4" defaultMessage={`You can exchange right now.
						The transaction is direct and within 2 minutes.`} />
					</p>
				</div>
			</article>
			...
			<article styleName="advantage">
				...
				<div styleName="advantage__txt">
					<p>
						<FormattedMessage id="advantagesTxt5" defaultMessage={`We don’t store your funds or keys so no-one can still your money from us.`} />
					</p>
				</div>
			</article>
			...
			<article styleName="advantage">
				...
				<div styleName="advantage__txt">
					<p>
						<FormattedMessage id="advantagesTxt6" defaultMessage={`No personal data is required, no tracing. Everything works on full anonymity.`} />
					</p>
				</div>
			</article>
