...
const Quote = ({ }) => {
  ...
  return (
    <div styleName="container">
      ...
      <FormattedMessage
          id="Quote"
          defaultMessage="The AtomicSwapWallet.io project realizes swaps among Bitcoin-like, Ethereum-like, and EOS cryptocurrencies, and made a product for users to execute swaps"
        />
        &#34;
    </div>
