          ...
          <Fragment>
            ...
            >
              <td style={{ position: 'relative' }}>
                ...
                {
                  currency === 'EOS' && <button styleName="button" onClick={this.handleEosRegister} data-tip data-for="another">Use another</button>
                }
                <ReactTooltip id="another" type="light" effect="solid">
                  <span>Login with your existing eos account</span>
                </ReactTooltip>
                {
                  currency === 'TLOS' && address === '' && <button styleName="button" onClick={this.handleTelosRegister} data-tip data-for="TLOS">Login</button>
                }
                <ReactTooltip id="TLOS" type="light" effect="solid">
