  ...
  render() {
    ...
    const titleSwapOnline = defineMessages({
      metaTitle: {
        id: 'Wallet140',
        defaultMessage:
          'wallet.Online - Cryptocurrency Wallet with Atomic Swap Exchange',
      },
    })
