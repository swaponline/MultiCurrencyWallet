...
export default class BtcToEthToken extends Component {
  ...
  constructor({ swap, currencyData, ethData, continueSwap, enoughtBalance }) {
    super()
  ...
  render() {
    ...
    const { currencyAddress, secret, flow, enabledButton, destinationAddressTimer, continuerSwap, isTextCopied, isAddressCopied, ethAddress, enoughtBalance } = this.state
