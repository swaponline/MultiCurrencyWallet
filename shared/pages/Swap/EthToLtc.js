    ...
    return (
      <div>
        ...
        }
        {
          flow.step === 1 && (
            <Fragment>
              <FormattedMessage id="EthToLtc125" defaultMessage="Confirmation of the transaction is necessary for crediting the reputation. If a user does not bring the deal to the end he gets a negative reputation.">
