...
const text = [
  { context: `1. We can list your token on swap.online ;`, id: 1 },
  { context: `2. To list your tokens, please send us the link to your peoject, erc20 address, icon, name and ticker (short name) to team@swap.online;`, id: 2 },
  { context: `3. We as well will announce listing of your tokens on our social media, mutial PR will benefit both sides.`, id: 3 },
  { context: `Crypto Pink Sheets: ALL Coins Welcome To SWAP.Online!`, id: 4 },
  { context: `OTC-approach-crypto market to be opened in Aug, 2018.`, id: 5 },
  { context:`There was one company in the U.S. in the year of 1913, the National Quotation Bureau.
    ...
    U.S. stock trades were over-the-counter.`, id: 6 },
  { context: `Wal-Mart was the Pink Sheet company in 1972 and earned there USD 1B.`, id: 7 },
  { context: `Navistar International, the 12-billion-dollar-corporation, came to the
    Pink Sheets Market in 2006 leaving the NYSE due to some issues with the auditor board..`, id: 8 },
  { context:
  <p>
    <FormattedMessage
      id="Listing6"
  ...
  id: 9 },
  { context:`SWAP.Online will be cryptocurrency Pink Sheets market.`, id:10 },
  { context:   <img src={ListingImg} styleName="listingImg" alt="Orders book on swap.online" />, id:11 },
  { context: `It’s well known that even in traditional stock market, one willing to be quoted must meet the requirements of SEC,
    ...
    to the SEC or SEC-approved regulators.`, id: 12 },
  { context:`Some of the cryptocurrency ‘fat cats’ allow themselves to do the same. For example, Localbitcoins CEO said they would
  ...
  { context: `That is not about us.`, id: 14 },
  { context: `As our transactions is peer-to-peer, based on the Atomic Swaps technology, we can add to the balances every token corresponding
    some our criterias. Obviously, clearly fraudulent projects are to be rejected from the very beginning. But all other
    start-ups on the different stages of development are welcome.`, id: 15 },
  { context: `In contradiction to the widespread Ethereum-pegged exchanges, the main currency to be changed on tokens in our project is
    Bitcoin. It can be treated as our killer-feature: for the crypto-newbies and vast majority of small customers Bitcoin
    is much clearer and easy to buy via Localbitcoins etc.`, id: 16 },
  { context: `We offer two-level way of access to the balances. On the first stage, we analyze the level of project technical development,
    collect the basic information (name, ticker, logo) and add the token to trading balances.`, id: 17 },
  { context: `Then, to start trading with Bitcoin, the project should publish the information about the collaboration with SWAP.Online
    on every social platform and on the web-site forum. With this information published, our developers will release the final
    version of the exchange to client’s token. This option is available for the first ten projects only.`, id: 18 },
  { context: `The conditions of delisting are discussed, but at the moment, we plan to expel twenty per cent worst tokens every month.`, id: 19 },
  { context: `Thus, you token can start to be quoted in free and decentralized manner as quickly as possible for your unlimited profit.`, id: 20 },
  { context: `Stay with us.`, id: 21 },
  { context: `Grow with us.`, id: 22 },
  { context: `Earn with us.`, id: 23 },
]
