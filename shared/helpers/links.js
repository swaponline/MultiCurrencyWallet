export default {
  ...
  feed: '/feed',
  aboutus: '/aboutus',
  listing: 'https://listing.Atomicswapwallet.io/',
  ...
  faq: [
    ...
    {
      question: 'Atomicswapwallet.io token',
  ...
  footer: {
    ...
    widget: 'https://widget.Atomicswapwallet.io/',
    ...
    forerc20tokens: 'https://listing.Atomicswapwallet.io/',
    fornewswebsites: 'https://widget.Atomicswapwallet.io/',
