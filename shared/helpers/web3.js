...
//   keychain.command({ command: 'version' }, function (err, result) {
...
//   const resKch = await web3.eth.accounts.signTransaction(transactionParams, 'test1@a163e24363c73ce3')
//   console.log('resKch: ', resKch);
//
//
//
// }
