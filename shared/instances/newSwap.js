...
import { ETH2BTC, BTC2ETH, BCH2ETH, ETH2BCH, LTC2BTC, BTC2LTC, ETH2LTC, LTC2ETH, ETHTOKEN2BTC, BTC2ETHTOKEN, EOS2BTC, BTC2EOS/* USDTOMNI2ETHTOKEN */, ETHTOKEN2USDT, QTUM2BTC, BTC2QTUM } from 'swap.flows'
import { EthSwap, EthTokenSwap, BtcSwap, BchSwap, LtcSwap, EosSwap, QtumSwap /* UsdtOmniSwap */ } from 'swap.swaps'
  ...
  SwapApp.setup({
    ...
    swaps: [
      ...
      new QtumSwap({
        ...
        /* eslint-enable */
        // fetchBalance: (address) => actions.qtum.getBalance(), // TODO write getBalanceFunc
        estimateGasPrice: 400,
        gasLimit: 3e6,
      }),
      new BtcSwap({
