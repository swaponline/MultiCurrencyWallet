  ...
  swapApp.setup({
    ...
    swaps: [
      new EthSwap({
        ...
        gasLimit: ethData.gasRate.limit,
        /* eslint-disable */
        ...
        getGasRate: () => actions.eth.getGasRate(),
      }),
      new BtcSwap({
        ...
        getFeeRate: () => actions.btc.getFeeRate(),
      }),
      new LtcSwap({
        ...
        getFeeRate: () => actions.ltc.getFeeRate(),
      }),
      new EosSwap({
      ...
      ...(Object.keys(config.erc20)
        .map(key =>
          new EthTokenSwap({
            ...
            getGasRate: () => actions.token.getGasRate(),
            /* eslint-disable */
