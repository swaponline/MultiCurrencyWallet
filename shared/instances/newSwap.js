...
import { ETH2BTC, BTC2ETH, ETHTOKEN2BTC, BTC2ETHTOKEN, BTC2EOS, EOS2BTC } from 'swap.flows'
  ...
  swapApp.setup({
    ...
    swaps: [
      ...
      new EthTokenSwap({
        ...
        decimals: config.erc20.swap.decimals,
        ...
        tokenAddress: config.erc20.swap.address,
        ...
        fetchBalance: (address) => actions.token.fetchBalance(address, config.erc20.swap.address, config.erc20.swap.decimals),
      }),
    ],
    flows: [
      ETH2BTC,
