  ...
  swapApp.setup({
    ...
    swaps: [
      new EthSwap({
        ...
        gasLimit: 1e5,
        abi: [
          { constant: false, inputs: [{ name: 'val', type: 'uint256' }], name: 'testnetWithdrawn', outputs: [], payable: false, stateMutability: 'nonpayable', type: 'function' },
          {
            constant: false,
            inputs: [{ name: '_secret', type: 'bytes32' }, { name: '_ownerAddress', type: 'address' }],
            name: 'withdraw',
            outputs: [],
            payable: false,
          ...
          { constant: true, inputs: [], name: 'owner', outputs: [{ name: '', type: 'address' }], payable: false, stateMutability: 'view', type: 'function' },
          {
            ...
            inputs: [{ name: '', type: 'address' }, { name: '', type: 'address' }],
            name: 'swaps',
            outputs: [{ name: 'secret', type: 'bytes32' }, { name: 'secretHash', type: 'bytes20' }, { name: 'createdAt', type: 'uint256' }, { name: 'balance', type: 'uint256' }],
            payable: false,
            stateMutability: 'view',
            type: 'function',
          },
          {
            constant: false,
            inputs: [{ name: '_secretHash', type: 'bytes20' }, { name: '_participantAddress', type: 'address' }],
            name: 'createSwap',
            outputs: [],
            payable: true,
          ...
          { constant: true, inputs: [], name: 'ratingContractAddress', outputs: [{ name: '', type: 'address' }], payable: false, stateMutability: 'view', type: 'function' },
          {
            constant: true,
          ...
          {
            anonymous: false,
            inputs: [{ indexed: false, name: '_secret', type: 'bytes32' }, { indexed: false, name: 'addr', type: 'address' }, { indexed: false, name: 'amount', type: 'uint256' }],
            name: 'Withdraw',
            type: 'event',
          },
        ...
        key =>
          new EthTokenSwap({
            ...
            abi: [
              ...
              {
                constant: false,
                inputs: [{ name: '_ratingContractAddress', type: 'address' }],
              ...
              { inputs: [], payable: false, stateMutability: 'nonpayable', type: 'constructor' },
              { anonymous: false, inputs: [], name: 'Sign', type: 'event' },
              { anonymous: false, inputs: [{ indexed: false, name: 'createdAt', type: 'uint256' }], name: 'CreateSwap', type: 'event' },
    ...
    flows: [
      ...
      ...Object.keys(config.erc20).map(key => ETHTOKEN2USDT(key)),

      ...Object.keys(config.erc20).map(key => USDT2ETHTOKEN(key)),
    ],
  })
