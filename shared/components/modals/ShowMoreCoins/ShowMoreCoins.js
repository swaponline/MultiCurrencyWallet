...
@connect(({ core: { hiddenCoinsList }, user: { ethData, btcData, ltcData, telosData, bchData, tokensData, eosData, nimData, usdtData, xlmData }, currencies: { items: currencies } }) => ({
  tokens: Object.keys(tokensData).map(k => tokensData[k]),
  items: [ethData, btcData, eosData, usdtData, bchData, ltcData, telosData, xlmData /* eosData  nimData */],
  currencies,
  hiddenCoinsList,
}))
