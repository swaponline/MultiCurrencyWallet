...
@connect(({
  ...
  user: { ethData, btcData, ltcData, qtumData, telosData, /* xlmData, */ bchData, tokensData, eosData, nimData /* usdtOmniData */ },
  currencies: { items: currencies },
}) => ({
  tokens: Object.keys(tokensData).map(k => tokensData[k]),
  items: [ethData, btcData, eosData, /* xlmData, */ bchData, ltcData, qtumData, telosData /* eosData, usdtOmniData, nimData */],
  currencies,
  hiddenCoinsList,
}))
