            ...
            <div styleName="userTooltip" >
              <div key={peer}>
                ...
                <div styleName="currency">
                  <span>{buyAmount.toNumber().toFixed(6)} <span styleName="coin">{buyCurrency}</span></span>
                  <span styleName="arrow"><img src={ArrowRightSvg} alt="" /></span>
                  <span>{sellAmount.toNumber().toFixed(6)} <span styleName="coin">{sellCurrency}</span></span>
                </div>
              </div>
