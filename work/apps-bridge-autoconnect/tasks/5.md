...
- [ ] Modal suppression verified by unit test `test_modal_suppressed_in_bridge_mode` which checks that component returns null in bridge mode with active connection
